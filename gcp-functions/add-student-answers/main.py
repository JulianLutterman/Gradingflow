...
- For most answers, no visual will be given, in this case you can just omit the "answer_visual" object. In case ONLY a visual is given, and no text, then you should omit "answer_text" instead.
